...
const paymentOptions = document.querySelectorAll('input[name="payment_methode"]');

// Function to update price based on the selected tab
function updatePrice() {
    const selectedPayment = document.querySelector('input[name="payment_methode"]:checked').value;
