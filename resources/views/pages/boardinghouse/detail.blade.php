    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide !w-fit">
            <div class="flex shrink-0 w-[320px] h-[430px] overflow-hidden">
                <img src="{{asset('')}}uploads/{{$item->image}}" class="object-cover w-full h-full"
...
<div id="TabsContent" class="px-5">
    <div id="Bonus-Tab" class="flex flex-col gap-5 tab-content">
        <div class="flex flex-col gap-4">
            @foreach ($boardinghouse->bonuses as $item)
            <div class="bonus-card flex items-center rounded-[22px] border border-[#F1F2F6] p-[10px] gap-3 hover:border-[#91BF77] transition-all duration-300">
                <div class="flex w-[120px] h-[90px] shrink-0 rounded-[18px] bg-[#D9D9D9] overflow-hidden">
                    <img src="{{asset('')}}uploads/{{$item->image}}" class="object-cover w-full h-full" alt="thumbnails">
                </div>
                <div>
    ...
    <div id="Testimonials-Tab" class="flex-col hidden gap-5 tab-content">
        <div class="flex flex-col gap-4">
             @foreach ($boardinghouse->testimonials as $item)
            ...
            <div class="flex items-center gap-3">
                ...
                <img src="{{asset('')}}uploads/{{$item->photo}}" class="object-cover w-full h-full"
                alt="icon">
            </div>
            <div>
                <p class="font-semibold">{{$item->name}}</p>
                <p class="mt-[2px] text-sm text-ngekos-grey">{{$item->created_at}}</p>
            </div>
        </div>
