...
<form action="{{route('booking.payment', $boardinghouse->slug)}}" class="relative flex flex-col gap-6 pt-5 mt-5" method="POST">
    ...
    <div id="PaymentOptions" class="flex flex-col rounded-[30px] border border-[#F1F2F6] p-5 gap-4 mx-5">
        <div id="TabButton-Container" class="flex items-center justify-between border-b border-[#F1F2F6] gap-[18px]">
            <label class="relative flex flex-col justify-between gap-4 tab-link group" data-target-tab="#DownPayment-Tab">
                <input type="radio" name="payment_methode" value="down_payment" class="absolute opacity-0 -z-10 top-1/2 left-1/2" checked>
                <div class="flex items-center gap-3 mx-auto">
                    <div class="relative w-6 h-6">
                        <img src="{{ asset('') }}assets/images/icons/status-orange.svg" class="absolute w-6 h-6 flex shrink-0 opacity-0 group-has-[:checked]:opacity-100 transition-all duration-300" alt="icon">
                        <img src="{{ asset('') }}assets/images/icons/status.svg" class="absolute w-6 h-6 flex shrink-0 opacity-100 group-has-[:checked]:opacity-0 transition-all duration-300" alt="icon">
                    </div>
                    <p class="font-semibold">Down Payment</p>
                </div>
                <div class="w-0 mx-auto group-has-[:checked]:ring-1 group-has-[:checked]:ring-[#91BF77] group-has-[:checked]:w-[90%] transition-all duration-300">
                </div>
            </label>
            <div class="flex h-6 w-[1px] border border-[#F1F2F6] mb-auto"></div>
            <label class="relative flex flex-col justify-between gap-4 tab-link group" data-target-tab="#FullPayment-Tab">
            <input type="radio" name="payment_methode" value="full_payment" class="absolute opacity-0 -z-10 top-1/2 left-1/2">
            <div class="flex items-center gap-3 mx-auto">
                <div class="relative w-6 h-6">
...
@endphp
    <div id="DownPayment-Tab" class="flex flex-col gap-4 tab-content">
        <p class="text-sm text-ngekos-grey">Anda perlu melunasi pembayaran secara cash setelah melakukan survey koskos</p>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('') }}assets/images/icons/receipt-disscount.svg" class="flex w-6 h-6 shrink-0"
                    alt="icon">
